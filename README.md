![从输入 token 到模型输出的手绘流程图](./assets/readme-banner.png)
...
- [Kimi K3 学习笔记：一个 3T 级模型的三项核心设计](https://github.com/jamez-bondos/blog/issues/2)<br>
  从混合注意力、Stable LatentMoE 和 Block AttnRes 三个方向，拆解 Kimi K3 的核心架构。

- [从零实现 GPT-2 推理](https://github.com/jamez-bondos/blog/issues/1)<br>
  *大模型推理初学者指南* — 逐层拆解 GPT-2 模型架构，并用 PyTorch 从零实现完整的推理代码。

## RSS

[![订阅 RSS](https://img.shields.io/badge/RSS-订阅-F26522?logo=rss&logoColor=white)](https://raw.githubusercontent.com/jamez-bondos/blog/main/rss.xml)
